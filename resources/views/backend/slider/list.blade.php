...
<div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <h4 class="m-0 font-weight-bold text-primary">Slider Details
                    <a href="{{ route('slider.create') }}" class="btn btn-sm btn-primary" style="float:right;"><i class="fa fa-plus"></i> Add Slider</a> 
                </h4>
            </div>
            <div class="card-body">
                <table class="table w-100" id="dataTableBuilder">
                    <thead>
                        <tr>
                            ...
                            <th><div class="col-sm-12 datatable-form-filter no-padding"><input type="text" class="form-control" placeholder="" name="filter_subtitle" autocomplete="off"></div></th>
                            <th></th>
                            <th></th>
                        </tr>
                        <tr>

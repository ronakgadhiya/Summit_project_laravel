                ...
                window.LaravelDataTables["dataTableBuilder"] = $("#dataTableBuilder").DataTable({
                    ...
                    "ajax": {
                        data: function (d) {   
                            ...
                            d.subtitle = jQuery(".datatable-form-filter input[name='filter_subtitle']").val();
                            d.btntitle = jQuery(".datatable-form-filter input[name='filter_btntitle']").val();

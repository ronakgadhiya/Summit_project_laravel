    ...
    public function checkrights($row)
    {
        ...
        // $historyurl = route('attributes.history', [$row->id]);
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="' . route('blog.edit', $row->id) .'"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <style>
    .rotate-right {
 ...
 Edit</a>
    ...
    public function query(Blog $model)
    {
        ...
        if (request()->get('description', false)) {
            $model->where('description', 'like', "%" . request()->get("description") . "%");
        }
